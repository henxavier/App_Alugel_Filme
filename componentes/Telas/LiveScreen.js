...
export default LiveScreen = () => {
    return (
        <Container>
            ...
            <Header>
                <Text large bold>Filmes</Text>
                <SearchContainer>
                    <Search placeholder="Search live stream or games..." placeholderTextColor="#838383" />
                    <SearchIcon>
            ...
            <SectionContainer>
                ...
                <Text medium bold>Filmes Populares</Text>
            ...
            <SectionContainer>
                <LiveGamesTitle>
                    <Text medium bold>Passando Agora</Text>
                    <Text bold color="#819ee5">Ver todos</Text>
                </LiveGamesTitle>
            </SectionContainer>
